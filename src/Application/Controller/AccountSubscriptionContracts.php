...
class AccountSubscriptionContracts extends \OxidEsales\Eshop\Application\Controller\AccountController
{
    protected $_sThisTemplate = 'account_subscription_contracts';
    ...
    public function getBreadCrumb()
    {
        ...
        $aPath['title'] = Registry::getLang()->translateString('ACCOUNT_SUBSCRIPTION_CONTRACTS', $iBaseLanguage, false);
